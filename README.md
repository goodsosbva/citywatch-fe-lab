...
X-Ray는 이 프로젝트의 핵심 증명 장치입니다. 현재 UI 블록의 FSD 계층과 analytics remote 경계를 표시하며, 이후에는 선택한 관점에 따라 SSR 같은 렌더링 방식, OpenLayers·3D 같은 적용 기술, shared package와 remote 출처를 구분해 보여주는 Inspector로 확장합니다.
