...
X-Ray는 이 프로젝트의 핵심 증명 장치입니다. 현재 selector로 경계를 끄거나 전체·FSD-style 관점을 선택할 수 있으며, 이후에는 Module Federation, Monorepo, OpenLayers·3D 같은 구현 증거를 원하는 관점만 골라 보는 Inspector로 확장합니다.
