...
const implementationItems: ImplementationItem[] = [
  ...
  {
    evidence: "FSD 이름을 사용한 app·widget·feature·entity 책임 경계를 X-Ray로 표시합니다.",
    href: "/?xray=fsd-style",
    limit: "실제 폴더와 public API가 정식 FSD 규칙으로 재구성된 것은 아니므로 FSD-style만 증명합니다.",
    name: "FSD-style responsibility boundaries",
    state: "partial",
  },
  {
    evidence: "22단계에서 실제 slice 폴더·의존 방향·public API를 구성한 뒤 증명해야 합니다.",
    limit: "현재 X-Ray 라벨만으로 정식 FSD를 구현했다고 볼 수 없습니다.",
    name: "정식 FSD",
    state: "planned",
  },
  {
